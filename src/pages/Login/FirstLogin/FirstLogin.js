    ...
    function getInfo() {
        if (info) {
            return <div className="firstLogin--block__login--input">
                ...
                <input onChange={e => passwordHandler(e)} value={password} onBlur={(e => start(e))} type="text"
            ...
            {(passwordGo && passwordError) && <p style={{color: 'red'}}>{passwordError}</p>}
            <input onChange={e => passwordHandler(e)} value={password} onBlur={(e => start(e))} type="password"
                   name="Password" placeholder='Password' id=""/>
                    ...
                    <div className="firstLogin--block">
                        ...
                        <div className="firstLogin--block__login">
                            ...
                            <div className="firstLogin--block__login--div">
                                ...
                                <input className={'firstLogin--block__login--div__Email'}
                                       onChange={e => EmailHandler(e)} value={email} onBlur={(e => start(e))}
