                        ...
                        {selectedTab === 0 &&
                            <>
                                <div className="account--block-tabs__common-block">
                                   <h1>Общие</h1>
                                    <p>Управляйте данными учетной записи, которые вы предоставили Self Developing school, включая ваше <br/>имя, контактные данные и прочую информацию</p>
                                        <div className="account--block-tabs__common-block--personal">
                                            <div className="account--block-tabs__common-block--personal__personal-block">
                                                ...
                                                <div className="account--block-tabs__common-block--personal__personal-block--btn">
